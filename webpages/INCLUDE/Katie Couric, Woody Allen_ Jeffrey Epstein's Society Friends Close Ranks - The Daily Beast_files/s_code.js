...
var s_account="rtstdailybeastprod"
...
s.linkInternalFilters="javascript:,thedailybeast"
...
s.prop11=s.getTimeParting('h','-5','2009'); // Set hour 
s.prop12=s.getTimeParting('d','-5','2009'); // Set day
s.prop13=s.getTimeParting('w','-5','2009'); // Set Weekend / Weekday

/*Captures the link clicked on the homepage*/
s.prop16=s.getQueryParam('cid');
...
s.trackingServer="metrics.thedailybeast.com";
...
/*
     FILE ARCHIVED ON 08:50:00 Apr 05, 2011 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  esindex: 0.018
  cdx.remote: 7.951
  LoadShardBlock: 91.258 (3)
  PetaboxLoader3.datanode: 401.874 (4)
  PetaboxLoader3.resolve: 678.166 (2)
  load_resource: 1079.062
*/