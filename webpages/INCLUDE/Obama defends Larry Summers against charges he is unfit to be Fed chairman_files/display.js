	...
	for (var container, i = 0; container = formContainers[i]; i++) {
		...
		if (container.offsetWidth <= 400 && ! container.classList.contains('sailthru-subscribe-SM-display')) {
			if (container.className === 'sailthru-subscribe-grid-display') {
				...
				container.getElementsByClassName('sailthru-signup-display-message-wrapper')[0].classList.add('sailthru-wrapper-SM-display');
			}
			...
			container.getElementsByClassName('sailthru-signup-display-message-wrapper')[0].classList.remove('sailthru-message-wrapper');
			...
			if (container.className === 'sailthru-subscribe-grid-display') {
				...
				container.getElementsByClassName('sailthru-signup-display-message-wrapper')[0].classList.remove('sailthru-wrapper-SM-display');
